 ...
 * @ORM\Entity(repositoryClass="Editxt\ContentBundle\Repository\SubTitleRepository")
 */
class SubTitle extends AbstractTaxonomy {

    /**
     * @ORM\ManyToMany(targetEntity = "ContentItem", mappedBy = "subTitles", cascade={"persist"})
     */
